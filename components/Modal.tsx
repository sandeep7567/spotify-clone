  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        />
        <Dialog.Content
          className='fixed drop-shadow-md border-neutral-700 top-[50%] left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[28.125rem] translate-x-[-50%] translate-y-[-50%] rounded-md bg-neutral-800 p-[25px] focus:outline-none'
        >
